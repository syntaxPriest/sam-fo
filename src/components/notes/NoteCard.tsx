...
const NoteCard = ({ note, onClick, onDelete, isSelected }: NoteCardProps) => {
  ...
  return (
    <article
      onClick={onClick}
      className={cn(
        'group relative p-4 bg-white dark:bg-gray-800 rounded-xl border-2 cursor-pointer',
        'transition-all duration-200 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-600',
        isSelected
